...
<script type="text/javascript">
	...
	function f_link_next() {
		...
		switch (st) {
		  case '01':
			nextUrl="/pharmai/bio/formulation/selectRoutes.do";
			saveUrl="/pharmai/bio/formulation/saveStep1.do";
		  ...
		  case '02':
			nextUrl="/pharmai/bio/formulation/selectExcipient.do";
			saveUrl="/pharmai/bio/formulation/saveStep2.do";
		  ...
		  case '03':
		  	nextUrl="/pharmai/bio/formulation/selectCQAsList.do";
			saveUrl="/pharmai/bio/formulation/saveStep3.do";
		  ...
		  case '04':
			...
			nextUrl="/pharmai/bio/formulation/selectExperiment.do";
			saveUrl="/pharmai/bio/formulation/saveStep4.do";
		  ...
		  case '05':
			nextUrl="/pharmai/bio/formulation/selectDoE.do";
			saveUrl="/pharmai/bio/formulation/saveStep5.do";
	...
	function fnPrjCreate(){
		...
		jQuery.ajax({
			type : 'POST',
			dataType : 'json',
			url : '/pharmai/bio/formulation/projectCreateAjax.do',
			data : req,
			global: false, // 추가

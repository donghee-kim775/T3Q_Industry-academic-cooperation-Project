		...
		if(inputType == "sdf"){
			...
			var uploadFileList = Object.keys(fileList);
		 	...
		 	if(uploadFileList.length == 0){
				...
				//파일읽는부분
				$.ajax({
// 					url:"/pharmai/bio/formulation/getFileAjax.do",
...
// 						alert("입력된 화학명이 존재하지 않습니다. 공식 사이트(https://pubchem.ncbi.nlm.nih.gov/)에 접속해 해당하는 화학명의 smiles 값을 입력해주세요.");
		...
		setTimeout(function(){
			...
			if(fileType) {
				$.ajax({
					url : '/pharmai/bio/formulation/getApi1Ajax.do',
					type : 'post',
					dataType : 'json',
					data : param,
					async : false,

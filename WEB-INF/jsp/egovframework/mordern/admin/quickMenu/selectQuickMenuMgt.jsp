...
//<![CDATA[
	...
	function fnDelete(){
		if(confirm("삭제하시겠습니까?")){
			$("#aform").attr({action:"/admin/quickMenu/"+fnSysMappingCode()+"deleteQuickMenuMgt.do", method:'post'}).submit();
		}
	}

	//수정
	function fnUpdateForm(){
		$("#aform").attr({action:"/admin/quickMenu/"+fnSysMappingCode()+"updateFormQuickMenuMgt.do", method:'post'}).submit();
	}
//]]>
</script>
<div class="content">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<form role="form" id="aform" method="post" action="/admin/quickMenu/updateFormQuickMenuMgt.do" enctype="multipart/form-data">

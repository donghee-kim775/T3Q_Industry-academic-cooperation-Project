...
<script type="text/javascript">
	...
	function fnGoPage(currentPage) {
		...
		$("#aform").attr({action : "/admin/stats/"+fnSysMappingCode()+"selectListSatisfactionAvg.do",method : 'post'}).submit();
	}
...
<div class="content">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<form role="form" id="aform" method="post" action="/admin/stats/selectListSatisfactionAvg.do">
									...
									<tbody>
										<c:forEach var="item" items="${resultList}" varStatus="status">
											<tr>
												...
												<td class="text-center">${item.AVG_STSFDG_SCORE}</td>

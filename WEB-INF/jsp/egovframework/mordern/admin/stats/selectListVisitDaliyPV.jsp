...
//<![CDATA[
	...
	//검색
	function fnSearch(){
		$("#aform").attr({action:"/admin/stats/selectListVisitDaliyPV.do", method:'get'}).submit();
	}

	// 엑셀다운로드
	function fnDownloadExcel(){
		$('#aform').attr({action:'/admin/stats/selectListVisitDaliyExcelPV.do', method:'get'}).submit();
	}
//]]>
</script>
<div class="wrapper">

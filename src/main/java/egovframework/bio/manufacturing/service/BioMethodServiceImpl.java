 ...
 * <PRE>
 * 1. ClassName :
 * 2. FileName  : BioMethodServiceImpl.java
...
@Service("bioMethodService")
public class BioMethodServiceImpl extends EgovAbstractServiceImpl implements BioMethodService{
	...
	// 바이오의약품 제조 step1 save
	public void insertPrjMst(DataMap param) throws Exception {
		commonMybatisDao.insert("pharm.manufacturing.bioInsertPrjMst",param);
	}

...
import egovframework.bio.manufacturing.service.BioManuResultService;
...
import egovframework.pharmai.manufacturing.web.ManuResultContorller;
 ...
 */
@Controller
public class BioManuResultContorller {

	private static Log log = LogFactory.getLog(ManuResultContorller.class);

	@Resource(name = "bioManuResultService")
	private BioManuResultService bioManuResultService;
	...
	// step8 첫 화면 호출
	@RequestMapping(value = "/pharmai/bio/manufacturing/selectManu_Result.do")
	public String selectManu_Result(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
		...
		DataMap selectStp09_pareto_graph = bioManuResultService.selectMenufacStep09_pareto(param);
		DataMap selectStp09_response_graph = bioManuResultService.selectMenufacStep09_response(param);
		DataMap selectStp09_contour_graph = bioManuResultService.selectMenufacStep09_contour(param);
		...
		if(selectStp09_pareto_graph == null) {
			...
			List selectStp10DesignList = bioManuResultService.selectStp10DesignList(param);
			DataMap selectStp10DesignImg = bioManuResultService.selectStp10DesignImgData(param);
			...
			List selectStp10ReusltList = bioManuResultService.selectStp10result(param);
			DataMap selectStp10ResultDataMap = bioManuResultService.selectStp10ResultImg(param);
			...
			if(selectStp10ReusltList.size() == 0 || selectStp10ResultDataMap== null ) {
				...
				List selectStp06 = bioManuResultService.selectMenufactStep06List(param);
				List selectStp10Design = bioManuResultService.selectStp10DesignList(param);
		...
		return "bio/manufacturing/selectManu_Result";
	}
	...
	// api7 호출
	@RequestMapping(value = "/pharmai/bio/manufacturing/getApi7Ajax.do")
	public @ResponseBody DataMap getManuApi7Ajax(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
		...
		List stp07dtl = bioManuCQAsService.selectMenufacStep07(param);
		...
		List stp06dtl = bioManuExperimentService.selectStp_06_data(param);
...
//			data = parser.parse(sb.toString());
			...
			bioManuResultService.insertMenufacStep09(param);
	...
	// api8 호출
	@RequestMapping(value = "/pharmai/bio/manufacturing/getApi8Ajax.do")
	public @ResponseBody DataMap getApi8_resultAjax(HttpServletRequest request, HttpServletResponse response, ModelMap model)
		...
		List selectMenufacStep07 = bioManuCQAsService.selectMenufacStep07(param);
		List selectExperientList = bioManuExperimentService.selectStp_06_data(param);
...
//			data = parser.parse(sb.toString());
		...
		bioManuResultService.insertManufactStep10(param);
	...
	@RequestMapping(value = "/pharmai/bio/manufacturing/excelDown.do")
	public void excelDown(HttpServletRequest request, HttpServletResponse response, ModelMap model)
		...
		List selectStp10ResultList = bioManuResultService.selectStp10result(params);
		List selectStp06ResultList= bioManuResultService.selectMenufactStep06List(params);
		List selectStp10Design = bioManuResultService.selectStp10DesignList(params);
		...
		try (InputStream input = new BufferedInputStream(cpr.getInputStream())) {// 1
			...
			response.setHeader("Content-Disposition", "atachment; filename=\"bioManufacturing_"+System.currentTimeMillis()+".xlsx\"");
			...
			context.putVar("title", "PharmAI 바이오의약품 제조 결과 Report");

...
import egovframework.bio.manufacturing.service.BioCPP_FactorService;
...
import egovframework.pharmai.manufacturing.web.CPP_FactorController;
 ...
 * <PRE>
 * 1. ClassName :
 * 2. FileName  : BioCPP_FactorController.java
 ...
 */
@Controller
public class BioCPP_FactorController {
	...
	@Resource(name= "bioCpp_FactorService")
	private BioCPP_FactorService bioCpp_FactorService;
	
	@Resource(name = "bioMethodService")
	private BioMethodService bioMethodService;
	
	@RequestMapping(value = "/pharmai/bio/manufacturing/selectManu_CPP_Factor.do")
	public String selectManu_CPP_Factor(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
		...
		List cqaList = bioCpp_FactorService.selectMenufactStep06(param);
		if(cqaList.size() > 0) {
		...
		return "bio/manufacturing/selectManu_CPP_Factor";
	}
	
	@RequestMapping(value = "/pharmai/bio/manufacturing/saveStep06.do")
	public String insertStep06(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception{
		...
		bioCpp_FactorService.insertMenufactStep06(param);

		//마지막 수정일
		bioManufacturingMgtService.updatePjt_mst(param);

		return "redirect: /pharmai/bio/manufacturing/selectManu_CQAs.do";
	}

	@RequestMapping(value = "/pharmai/bio/manufacturing/getApi4_1Ajax.do")
	public @ResponseBody DataMap getApi4_1Ajax(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
		...
		List stp1_dtl = bioMethodService.selectManufacturingStep1(param);
		DataMap stp5_dtl = bioCpp_FactorService.selectDistinctUnitStp05(param);

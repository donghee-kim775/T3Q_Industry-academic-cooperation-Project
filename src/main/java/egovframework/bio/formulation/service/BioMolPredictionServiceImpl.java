...
@Service("bioMolPredictionService")
public class BioMolPredictionServiceImpl extends EgovAbstractServiceImpl implements BioMolPredictionService{
	...
	public void insertFormulaStp_01(DataMap param) throws Exception{
		...
		if(createPrjYn == null) {
			commonMybatisDao.insert("pharmai.formulation.bioInsertPrjMst", param);
		}

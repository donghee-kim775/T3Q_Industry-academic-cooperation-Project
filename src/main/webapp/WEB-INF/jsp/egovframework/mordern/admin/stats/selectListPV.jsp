...
<script type="text/javascript">
	...
	$(function() {
		...
		$('[name=sch_sys_code]').change(function(e) {
			...
			$('[name=sch_text]').val("");
			$("#currentPage").val("1");
			$("#aform").attr({action : "/admin/stats/"+fnSysMappingCode()+"selectListPV.do", method : 'post'}).submit();
		});
							...
							<div class="form-row justify-content-between">
								...
								<div class="form-inline">
									...
									<div class="input-group input-group-sm mr-1 mb-1">
										...
										<input type="text" class="form-control input-sm" name="sch_end_de" value="${requestScope.param.sch_end_de}" placeholder="로그 종료일" />
									</div>
									<div class="input-group input-group-sm mr-1 mb-1">
										<input type="text" class="form-control form-control-sm"	name="sch_text" title="메뉴명을 입력하세요." placeholder="메뉴명을 입력하세요." value="${requestScope.param.sch_text}" />
									...
									<tbody>
										<c:forEach var="item" items="${resultList}" varStatus="status">
											<tr>
												...
												<td class="text-center">${item.ACCES_CNT}</td>
											</tr>
										</c:forEach>

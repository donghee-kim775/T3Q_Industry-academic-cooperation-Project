...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if(step_new == 'Y'){
			...
			$.ajax({
				url: "/pharmai/bio/formulation/getApi6Ajax.do",
				type: 'post',
				data: param,
				dataType : 'json',
				async : false,
				success: function(response){
					...
					if(code == "000"){
						...
						var redirectUrl = "/pharmai/bio/formulation/selectExperiment.do?prjct_id="+prjct_id;
						switch (code){
							//스텝5
							case '001':
							case '002':
...
// 						globals.properties의 env 값 받아오기
	...
	function excelDownload(){
		...
		$('#aform').attr({action:'/pharmai/bio/formulation/excelDown.do'}).submit();
	}

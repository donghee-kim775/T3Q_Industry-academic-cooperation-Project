...
<script type="text/javascript">
	...
	function f_link_next() {
		...
		switch (st) {
		  case '01':
			nextUrl="/pharmai/chemical/manufacturing/selectManu_Process_Map.do";
			saveUrl="/pharmai/manufacturing/saveStep01.do";
		  ...
		  case '02':
			nextUrl="/pharmai/chemical/manufacturing/selectManu_PHA.do";
			saveUrl="/pharmai/manufacturing/saveStep02.do";
		  ...
		  case '03':
		  	nextUrl="/pharmai/chemical/manufacturing/selectManu_FMEA.do";
			saveUrl="/pharmai/manufacturing/saveStep03.do";
		  ...
		  case '04':
			...
			nextUrl="/pharmai/chemical/manufacturing/selectManu_UNIT_IMG.do";
			saveUrl="/pharmai/manufacturing/saveStep04.do";
		  ...
		  case '05':
			nextUrl="/pharmai/chemical/manufacturing/selectManu_CPP_Factor.do";
			saveUrl="/pharmai/manufacturing/saveStep05.do";
		  ...
		  case '06':
		 	...
		 	nextUrl="/pharmai/chemical/manufacturing/selectManu_CQAs.do";
			saveUrl="/pharmai/manufacturing/saveStep06.do";
			...
			if($("[name=step_new]").val() == "Y"){
  			...
  			case '07':
			 	nextUrl="/pharmai/chemical/manufacturing/selectManu_Excipent.do";
				saveUrl="/pharmai/manufacturing/saveStep07.do";
  			...
  			case '08':
			 	nextUrl="/pharmai/chemical/manufacturing/selectManu_Result.do";
				saveUrl="/pharmai/manufacturing/saveStep08.do";

...
def runScript(value):
    print("###### runScript ######")
    CCD_DOE_Script = "./Rscript/BBDDoE.R"
    try:
        ...
        with localconverter(ro.default_converter + pandas2ri.converter):
            ...
            ## BBD_DOE ##
            #############
            BBD_DF = ro.conversion.rpy2py(ro.globalenv['df.bbd_DoE'])
            print("restart python")
            print("#### PYTHON_BBD_DF ####")
            print(BBD_DF)

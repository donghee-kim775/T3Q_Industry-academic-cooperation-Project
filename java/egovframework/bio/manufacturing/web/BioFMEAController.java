...
import egovframework.bio.manufacturing.service.BioFMEAService;
...
import egovframework.pharmai.manufacturing.web.FMEAController;
 ...
 * <PRE>
 * 1. ClassName :
 * 2. FileName  : BioFMEAController.java
 ...
 */
@Controller
public class BioFMEAController {
	...
	@Resource(name = "bioFMEAService")
	private BioFMEAService bioFMEAService;
	...
	// step4 첫 화면 호출 
	@RequestMapping(value = "/pharmai/bio/manufacturing/selectManu_FMEA.do")
	public String selectManu_FMEA(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
		...
		List resultList = bioFMEAService.selectformulaStep4(param);// stp04
		...
		return "bio/manufacturing/selectManu_FMEA";
	}
	
	// step4 save 기능
	@RequestMapping(value = "/pharmai/bio/manufacturing/saveStep04.do")
	public String saveStep04(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
		...
		bioFMEAService.insertMenufacStep04(param);

		//마지막 수정일
		bioManufacturingMgtService.updatePjt_mst(param);

		return "redirect: /pharmai/bio/manufacturing/selectManu_UNIT_IMG.do";
	}
	
	// api4 호출
	@RequestMapping(value = "/pharmai/bio/manufacturing/getApi4Ajax.do")
	public @ResponseBody DataMap getApi4Ajax(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
		...
		DataMap cqaValData = bioFMEAService.selectCqaValList(param);

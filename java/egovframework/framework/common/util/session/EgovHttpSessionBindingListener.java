package egovframework.framework.common.util.session;
...
public class EgovHttpSessionBindingListener implements HttpSessionBindingListener {
	private static Log log = LogFactory.getLog(EgovHttpSessionBindingListener.class);
...
//		System.out.println("loginusers : " + EgovMultiLoginPreventor.loginUsers.toString());
		log.error("loginusers : " + EgovMultiLoginPreventor.loginUsers.toString());
	}
